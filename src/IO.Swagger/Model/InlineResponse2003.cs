...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse2003 :  IEquatable<InlineResponse2003>, IValidatableObject
    {
        ...
        /// <param name="history">The fax jobs requested.</param>
        public InlineResponse2003(string status = default(string), List<InlineResponse2003History> history = default(List<InlineResponse2003History>))
        {
            this.Status = status;
        ...
        /// </summary>
        /// <value>The fax jobs requested</value>
        [DataMember(Name="history", EmitDefaultValue=false)]
        public List<InlineResponse2003History> History { get; set; }
