...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse2002 :  IEquatable<InlineResponse2002>, IValidatableObject
    {
        ...
        /// <param name="userCashBalance">Remaining cash balance.</param>
        public InlineResponse2002(string status = default(string), string message = default(string), decimal? userCashBalance = default(decimal?))
        {
            this.Status = status;
        ...
        /// </summary>
        /// <value>Remaining cash balance</value>
